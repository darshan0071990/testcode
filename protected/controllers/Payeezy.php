...
class Payeezy
{
   ...
   */
  public static $apiKey = "ZvyPrlbXAFk6PLtllpVGbM2GnxNJLfQY";
  public static $apiSecret = "e641b89f477ba523f6f0e3e3ef576a47c5c89f8f97733c2efa4854f4eba15044";
  public static $merchantToken = "fdoa-75974a80f2c47583f25bf8bf57b05731d0df26104a83431c";
  public static $baseURL = "https://api-cert.payeezy.com/v1/transactions";
  public static $url;
  ...
  {
      $payload = Payeezy::getPayload($args, "authorize");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);

      return Payeezy::postTransaction($payload, $headerArray);
  }
  ...
  {
      $payload = Payeezy::getPayload($args, "purchase");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);
      return Payeezy::postTransaction($payload, $headerArray);
  }
  ...
  {
      $payload = Payeezy::getPayload($args, "capture");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);
      return Payeezy::postTransaction($payload, $headerArray);
  }
  ...
  {
      $payload = Payeezy::getPayload($args, "void");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);
      return Payeezy::postTransaction($payload, $headerArray);
  }
  ...
  {
      $payload = Payeezy::getPayload($args, "refund");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);
      return Payeezy::postTransaction($payload, $headerArray);
  }
  ...
  {
      $payload = Payeezy::getPayload($args, "split");
      $headerArray = Payeezy::hmacAuthorizationToken($payload);
      return Payeezy::postTransaction($payload, $headerArray);
  }

			...
			'items' => array(
				array(
					...
					'items' => array(
						...
						array('label' => 'Club Events', 'items' => array(
								array('label' => 'View Club Events', 'url' => array('/clubEvent/index')),
								array('label' => 'Add Club Events', 'url' => array('/clubEvent/create')),
							),
						),
						
						array('label' => 'Bouncers', 'items' => array(
								array('label' => 'View Bouncers', 'url' => array('/users/index')),
								array('label' => 'Add Bouncers', 'url' => array('/users/create')),
								//array('label' => 'Import Users', 'url' => array('/users/import')),
							),
						),	
						
						array('label' => 'Report', 'url' => array('/report/index')),
						
						array('label' => 'Subscription', 'items' => array(
							array('label' => 'My Subscription', 'url' => array('/packages/subscribed')),
							array('label' => 'Buy Subscription', 'url' => array('/packages/buy')),
							),
						),
